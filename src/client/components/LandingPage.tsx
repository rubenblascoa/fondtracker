...
export function LandingPage({ user, onLogout }: { user: User | null; onLogout: () => void }) {
  ...
  return (
    <div className="font-primary bg-neutral-background text-text-primary overflow-x-hidden selection:bg-brand-primary selection:text-black min-h-screen flex flex-col relative grid-overlay">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li data-pixel-id="1trhu" data-pixel-kind="text"><a href="#how-it-works" className="text-sm text-text-secondary hover:text-brand-primary transition-colors" data-pixel-id="r8p0x" data-pixel-kind="link">How it Works</a></li>
                <li data-pixel-id="29ppk" data-pixel-kind="text"><a href="#tech-stack" className="text-sm text-text-secondary hover:text-brand-primary transition-colors" data-pixel-id="f5iw8" data-pixel-kind="link">Technology</a></li>
              </ul>
            </div>
            <div>
