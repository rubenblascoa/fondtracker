        ...
        <div className="flex-none">
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="space-y-3 mt-1">
              <li>
                <a href="https://rubenblascoa.github.io" target="_blank" rel="author" className="text-sm text-[var(--color-accent)] hover:underline transition-colors flex items-center justify-center sm:justify-start gap-2 group font-semibold">
                  <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                  rubenblascoa.github.io ↗
                </a>
              </li>
              <li>
